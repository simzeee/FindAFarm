...
def seed_farms():
    ...
    farm1 = Farm(name="Schrute Farms", amenityId=1, pricePerDay=150, location="Scranton", primaryImage="https://findafarmbucket.s3.amazonaws.com/b01504419f7d4355995d23d739ec0a96.jpeg", userId=2, description="Bears. Beets. Battlestar Galactica.")
    
    farm2 = Farm(name="Dairy Farm", amenityId=2, pricePerDay=100, location="Skokie", primaryImage="https://findafarmbucket.s3.amazonaws.com/64c06fb946904498b2d88bec6393b979.jpeg", userId=3, description="Enjoy a glass of milk. Have a slice of cheese.")
    
    farm3 = Farm(name="Sacred Groves", amenityId=3, pricePerDay=200, location="Seguine, Texas", primaryImage="https://findafarmbucket.s3.amazonaws.com/31d6fbd423774e13a544657d76f4c6d1.png", secondImage="https://findafarmbucket.s3.amazonaws.com/597b557c9ae24363b4d8c9a8a06fefc2.png", thirdImage='https://findafarmbucket.s3.amazonaws.com/513d9607a79341af8dc253b8b15f5ec9.png',
